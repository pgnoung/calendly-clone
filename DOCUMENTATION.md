# Just in time meeting - Documentation for Handover
...
| รายการ | รายละเอียด |
|--------|-----------|
| **ชื่อโปรเจค** | Just in time meeting |
| **เจ้าของระบบ** | พี่ง้วง (d.chawalid@gmail.com) |
| **วัตถุประสงค์** | ระบบนัดหมายออนไลน์สำหรับการจองประชุมกับพี่ง้วง |
...
### ข้อจำกัด
- จองล่วงหน้าได้สูงสุด 180 วัน (6 เดือน)
